                            ...
                            <div className='d-flex justify-content-center flex-wrap overflow-auto p-4 w-50 bg-backdrop'>
                                <form action='index.html' className='flex-fill'>
                                    <div className='mx-auto'>
                                        ...
                                        <div className='mb-4'>
                                            <h4>Restuarant</h4>
                                            <p>This is a Page for Restuarant's </p>
                                        </div>
                                    ...
                                    <p className='subtitle-entry'>Click here, If you are have a already been Registered your Restuarant</p>
                                    <div className='mx-auto '>
                                        <div className='d-grid mx-auto'>
                                            <OPButton
                                    ...
                                    <p className='subtitle-entry'>Click here, If you Want to Register your Restuarant to join with us</p>
                                </form>
                            </div>
                        </div>
                    </div>
